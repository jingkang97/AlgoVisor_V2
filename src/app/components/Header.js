...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 z-50 w-full bg-black/20 border-b border-[#333333] backdrop-blur-[9px]">
      <nav
        aria-label="Global"
        className="mx-auto flex max-w-7xl items-center justify-between p-1"
      >
          ...
          <a href="#" className="m-1.5 p-1.5 flex items-center space-x-2">
            ...
            <div>
              <img
                alt="AlgoVisor Logo"
                src="/algovisor.svg"
                className="h-8 w-auto transition duration-300 ease-in-out hover:filter hover:drop-shadow-[0_0_6px_#fff]"
              />
            </div>
            <h1 className="font-semibold">AlgoVisor</h1>
          </a>

          {/* Questions and Visualization links */}
          <PopoverGroup className="hidden lg:flex lg:gap-x-8">
            <Popover className="relative">
              <PopoverButton className="flex items-center gap-x-1 text-sm font-mona text-white-900 font-semibold">
                Questions
                <ChevronDownIcon
                  aria-hidden="true"
